(function (factory) {
	...
	*/
	...
	jquery(document).ready(() => {
	  ...
	  jquery(".main-slider-product").slick({
	    dots: true,
	    infinite: true,
	    speed: 300,
	    slidesToShow: 4,
	  ...
	  jquery(".main-slider-testmonial").slick({
	    infinite: true,
	    slidesToShow: 3,
	    slidesToScroll: 1,
	    centerMode: true,
	    arrows: true,
	    centerPadding: "100px",
	    nextArrow: jquery(".slick-next-main-testmonial"),
	    prevArrow: jquery(".slick-prev-main-testmonial"),
	    responsive: [{
	      breakpoint: 1024,
	      settings: {
	        slidesToShow: 3,
	...
	jquery(document).ready(function () {
	  jquery(".color").click(function () {
	    ...
	    jquery(this).find(".fa-check").show();
	  });
	  jquery(".size").click(function () {
	    jquery(".size").removeClass("active");
	    jquery(this).addClass("active");
	  });
	  jquery(".counter button:first-of-type").click(function () {
	    let countSpan = jquery(".counter span");
	  ...
	  jquery(".counter button:last-of-type").click(function () {
	    let countSpan = jquery(".counter span");
	    let count = parseInt(countSpan.text());
	    countSpan.text(count + 1);
	  });
	  jquery(".circle-color").click(function () {
	    jquery(".color").removeClass("active");
	    jquery(".fa-check").hide();
	    jquery(this).addClass("active");
	    jquery(this).find(".fa-check").show();
	  });
	  jquery(".type-size span").click(function () {
	    jquery(".type-size span").removeClass("active");
	    jquery(this).addClass("active");
	  });
	  jquery(".modal-star").click(function () {
	    jquery(".modal-star").removeClass("active text-white");
	    jquery(this).prevAll().addBack().addClass("active").removeClass("text-white");
	  });
	  jquery("#close").click(function () {
	    jquery(".offer-nav").hide();
	  });
